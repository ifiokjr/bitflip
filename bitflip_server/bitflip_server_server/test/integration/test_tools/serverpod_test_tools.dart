...
import 'package:bitflip_server_server/src/generated/endpoints.dart';
...
class _MintEndpoint {
  ...
  _ida.Future<_i5q6wjqb.MintChallengeView> createChallenge(
    _ist.TestSessionBuilder sessionBuilder, {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_i5q6wjqb.MintChallengeView>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _ida.Future<_iznr9q2m.MintSectionResult> mintSection(
    _ist.TestSessionBuilder sessionBuilder, {
    required String walletAddress,
    required int gameIndex,
    required int sectionIndex,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_iznr9q2m.MintSectionResult>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
