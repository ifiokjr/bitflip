...
- Verify ABI version 5 rejects a mint with live authority, nonzero decimals, the wrong supply, or unsupported extensions; reconcile the launch reserve, every funded section vault, emitted BIT, reward-pool ledger, protocol-fee ledger, and owner payments after the canary.
