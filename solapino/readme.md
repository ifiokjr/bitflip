...
**pino is a tiny solana smart contract framework.** It provides a library of helper functions, macros, and code patterns for building safe and maintainable smart contracts with pinocchio on the Solana blockchain.

## Notes

Rather than

- **pino is under active development. All interfaces are subject to change.**
