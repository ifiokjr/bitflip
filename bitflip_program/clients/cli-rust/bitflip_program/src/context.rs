...
impl CliContext {
	...
	pub fn pubkey(flag: &str, value: &str) -> Result<Pubkey, CliError> {
		value.parse().map_err(|source| CliError::InvalidPubkey {
			flag: flag.to_string(),
			source,
		})
	}
	...
	pub fn bytes<const N: usize>(flag: &str, value: &str) -> Result<[u8; N], CliError> {
		...
		decoded
			.try_into()
			.map_err(|actual: Vec<u8>| CliError::InvalidByteLength {
				flag: flag.to_string(),
				expected: N,
				actual: actual.len(),
			})
...
pub fn program_error_name(code: u32) -> Option<&'static str> {
	match code {
		0 => Some("Unauthorized"),
		1 => Some("InvalidConfiguration"),
		2 => Some("InvalidGameIndex"),
		3 => Some("GameNotLive"),
		4 => Some("GameNotStarted"),
		5 => Some("InvalidSectionIndex"),
		6 => Some("SectionLocked"),
		7 => Some("InvalidFlipCount"),
		8 => Some("InvalidCoordinate"),
		9 => Some("DuplicateCoordinate"),
		10 => Some("PriceSlippage"),
		11 => Some("SectionNotActive"),
		12 => Some("SectionNotSealed"),
		13 => Some("SectionAlreadyMinted"),
		14 => Some("InvalidAsset"),
		15 => Some("InsufficientFunds"),
		16 => Some("InvalidSalePrice"),
		17 => Some("SectionNotForSale"),
		18 => Some("SectionNotTransferable"),
		19 => Some("CannotPurchaseOwnSection"),
		20 => Some("OwnerChanged"),
		21 => Some("InvalidControllerTimestamp"),
		22 => Some("InvalidControllerState"),
		23 => Some("CustodyAlreadyConfigured"),
		24 => Some("CustodyNotConfigured"),
		25 => Some("InvalidBitMint"),
		26 => Some("InvalidBitTokenAccount"),
		27 => Some("SectionVaultAlreadyFunded"),
		28 => Some("StalePriceWindow"),
		29 => Some("InsufficientReward"),
		30 => Some("NoOwnerFees"),
		31 => Some("InvalidSectionPolicy"),
		32 => Some("SectionPolicyLocked"),
		33 => Some("SectionPolicyChanged"),
		34 => Some("InvalidFlipColour"),
		_ => None,
	}
}
