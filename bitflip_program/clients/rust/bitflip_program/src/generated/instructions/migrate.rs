...
pub struct Migrate {
	...
	pub config_state: Option<solana_pubkey::Pubkey>,
	pub game_state: Option<solana_pubkey::Pubkey>,
	pub section_state: Option<solana_pubkey::Pubkey>,
}
...
impl Migrate {
	...
	pub fn instruction_with_remaining_accounts(
		...
		if let Some(config_state) = self.config_state {
			accounts.push(solana_instruction::AccountMeta::new(config_state, false));
		} else {
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::BITFLIP_PROGRAM_ID,
				false,
		...
		if let Some(game_state) = self.game_state {
			accounts.push(solana_instruction::AccountMeta::new(game_state, false));
		} else {
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::BITFLIP_PROGRAM_ID,
				false,
		...
		if let Some(section_state) = self.section_state {
			accounts.push(solana_instruction::AccountMeta::new(section_state, false));
		} else {
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::BITFLIP_PROGRAM_ID,
				false,
