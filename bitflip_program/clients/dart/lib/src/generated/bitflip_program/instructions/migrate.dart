...
import '../programs/bitflip_program.dart' show bitflipProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  final resolvedProgram = programAddress ?? bitflipProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: gameState ?? resolvedProgram,
      role: gameState == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
      address: sectionState ?? resolvedProgram,
