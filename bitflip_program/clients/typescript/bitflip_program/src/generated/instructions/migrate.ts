...
export type MigrateInstruction<
	...
	TAccountConfigState extends string | AccountMeta<string> = string,
	TAccountGameState extends string | AccountMeta<string> = string,
	TAccountSectionState extends string | AccountMeta<string> = string,
...
> =
	...
	& InstructionWithAccounts<
		[
			...
			TAccountConfigState extends string ? WritableAccount<TAccountConfigState>
				: TAccountConfigState,
			TAccountGameState extends string ? WritableAccount<TAccountGameState>
				: TAccountGameState,
			TAccountSectionState extends string ? WritableAccount<TAccountSectionState>
				: TAccountSectionState,
			...TRemainingAccounts,
		]
	>;
...
export type MigrateInput<
	...
	TAccountConfigState extends string = string,
	TAccountGameState extends string = string,
	TAccountSectionState extends string = string,
> = {
	payer?: TransactionSigner<TAccountPayer>;
	systemProgram?: Address<TAccountSystemProgram>;
	configState?: Address<TAccountConfigState>;
	gameState?: Address<TAccountGameState>;
	sectionState?: Address<TAccountSectionState>;
};
...
> {
	...
	const programAddress = config?.programAddress
		?? BITFLIP_PROGRAM_PROGRAM_ADDRESS;

	// Original accounts.
	const originalAccounts = {
		payer: { value: input.payer ?? null, isWritable: true },
		systemProgram: { value: input.systemProgram ?? null, isWritable: false },
		configState: { value: input.configState ?? null, isWritable: true },
		gameState: { value: input.gameState ?? null, isWritable: true },
		sectionState: { value: input.sectionState ?? null, isWritable: true },
	};
	...
	// placeholder.
	const provided = [input.payer, input.systemProgram, input.configState, input.gameState, input.sectionState];
	let lastProvided = -1;
	...
	return Object.freeze({
		accounts: [
			...
			getAccountMeta("configState", accounts.configState),
			getAccountMeta("gameState", accounts.gameState),
			getAccountMeta("sectionState", accounts.sectionState),
